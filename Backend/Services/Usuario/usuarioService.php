...
class UsuarioService
{
    ...
    public function atualizarUsuario($usuarioDados, $emailUsuario)
    {
        ...
        try {
            ...
            $atualizar = $this->db->prepare('UPDATE usuario SET nome = :nome, email = :email, cpf = :cpf, senha = :senha, cargo = :cargo WHERE email = :email_usuario');
    ...
    public function deletarUsuario($emailUsuario)
    {
        ...
        try {
            ...
            if (str_contains($e->getMessage(), 'parent row')) {
                ...
                throw new Exception('Usuário referenciado não é possível de deletar', 500);
            }
